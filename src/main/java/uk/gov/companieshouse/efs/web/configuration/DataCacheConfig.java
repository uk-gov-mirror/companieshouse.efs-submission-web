...
public class DataCacheConfig {
    ...
    public static final String[] REF_DATA_CACHE_NAMES =
            {ALL_CATEGORIES, CATEGORY_BY_ID, CATEGORY_BY_PARENT, TOP_LEVEL_CATEGORY,
                    ALL_FORMS, FORM_BY_ID, FORM_BY_CATEGORY, IP_ALLOW_LIST};
